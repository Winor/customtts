...
- If no checkbox is checked, it will generate the audio sentence by sentence during playback. Credits to [sagesound](https://github.com/sagesound) for improving the code.
